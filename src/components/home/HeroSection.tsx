...
export function HeroSection() {
  ...
  return (
    <div ref={heroRef} className="relative overflow-hidden -mt-[81px] min-h-screen sm:min-h-0 pt-[140px] pb-20 sm:pt-[193px] sm:pb-28 lg:pt-[225px] lg:pb-36 flex flex-col justify-center items-center text-center bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
