...
export function MobileBottomNav() {
  ...
  return (
    <nav
      className={clsx(
        "fixed bottom-0 inset-x-0 z-30 bg-white/95 backdrop-blur-xl border-t border-slate-200 py-2 px-2 flex justify-around items-center md:hidden shadow-2xl transition-all duration-300 ease-in-out",
        isVisible
    ...
    >
      {navItems.map((item) => {
        ...
        return (
          ...
          >
            <Icon className={clsx("w-5 h-5 mb-0.5 transition-colors", isActive ? "text-primary stroke-[2.5]" : "text-slate-400")} />
