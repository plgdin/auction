...
export function AdminOverview() {
  const [analytics, setAnalytics] = useState({ totalUsers: 0, activeAuctions: 0, activeTenders: 0 });
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
          ...
          <h3 className="text-slate-500 text-sm font-semibold uppercase tracking-wider mb-1">Open Tenders</h3>
          <p className="text-3xl font-extrabold text-slate-900">{analytics.activeTenders}</p>
        </div>
      </div>
