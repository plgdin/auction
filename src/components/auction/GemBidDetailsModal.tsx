...
import { X, Copy, Check, Landmark, Download, MapPin, AlignLeft, Info, Clock, Eye, Heart, Calendar, FileText, Phone, UserCheck, ShieldCheck, ExternalLink } from 'lucide-react';
        ...
        <div className="flex-1 overflow-y-auto flex flex-col lg:flex-row">
          ...
          {(itemImage || availableDocs.length > 0) && (
            <div className="w-full lg:w-[420px] shrink-0 border-t lg:border-t-0 lg:border-l border-slate-200 bg-slate-50 p-5 overflow-visible lg:overflow-y-auto flex flex-col space-y-5">
              ...
              {/* Premium Document Preview Card (Clean, Uncluttered, Modern) */}
