                    ...
                    <table className="w-full text-left border-collapse text-xs">
                      <thead>
                        <tr className="bg-slate-50 text-slate-650 border-b border-slate-250 font-mono">
                          ...
                          <th className="py-2.5 px-3.5 font-bold text-center">Market Price</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-slate-100 text-slate-700">
                        {generateCatalogSummary(selectedPreviewItem).items.map((row) => (
                          <tr key={row.sr} className="hover:bg-slate-50/50">
                            ...
                            <td className="py-2.5 px-3.5 text-center font-mono text-xs text-emerald-600 font-bold bg-emerald-50/50">{row.marketPrice}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
