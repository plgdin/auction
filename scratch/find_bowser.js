...
async function check() {
  ...
  for (const record of records) {
    if (record.raw_materials_text && record.raw_materials_text.toLowerCase().includes('bowser')) {
      console.log(`Found Bowser in auction:`);
      ...
      try {
        ...
        console.log(`First item:`, JSON.stringify(parsed.items[0], null, 2));
      } catch (e) {
